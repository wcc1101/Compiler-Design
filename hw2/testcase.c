...
unsigned long long b[2][3];
const unsigned short c[4][5][6];
unsigned long d[7][8];
const unsigned char e[9][10];
float f[11];
const double g[12][13][14][15];
const float i[16][17][18], j[19], k[20][21], l[22][23][24];
short m[25][26], n[27], o[28][29][30];
// by redleaf23477
...
long long int a[3][foo()][bar(a,b)] = {
    ...
    },
    {
        ...
        { "lkjdfslkjdfslkjdfoiuw3oiwriuorwe", 8234849, (char*)&a&aa&a&a }
    },
...
int g = !13 / c;
int h = ! 14 == 15;
int i = 16 == 17 && 18 < (19 % h) || 20 != 21;
int j = 22 >= 23 || 24 && ! (25 == 26);
...
double num = -.1234;
double num = -1234.;
double num = 00.00000000;
double num = 00.1234;
double num = -00.;
double num = -122222222222.00000000000000000000;
double num = -00000000000.2222222222222222200000;
double num = +00.012;
int main() {
  int n = 10;
  for (i = 0 ; i < n; i++) a++;
...
const signed long long *a, b, *a, * as87asdfALFJAisljsosl;
const signed long *a, b;
const signed char *a, b;
const signed short *a, b;
...
int main(){
    ...
    while(a + -b != c){
        do{
            RapOfChina(TizzyT, GALI, MCHotDog, Capper);
            if(LeagueOfBaby == "win"){
                char* KeyNG = "Bow down to KeyNG";
                break;
            }
        }
        while("Hello" + "World" << "Z" == GALI);    
    }
